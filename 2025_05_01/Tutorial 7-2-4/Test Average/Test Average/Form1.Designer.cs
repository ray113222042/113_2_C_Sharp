namespace Test_Average
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            // insertButton
            // 
            this.insertButton.Location = new System.Drawing.Point(224, 280);
            ...
            // scoreTextBox
            // 
            this.scoreTextBox.Location = new System.Drawing.Point(12, 280);
            this.scoreTextBox.Name = "scoreTextBox";
            this.scoreTextBox.Size = new System.Drawing.Size(100, 22);
            this.scoreTextBox.TabIndex = 18;
            this.scoreTextBox.Text = "分數";
            this.scoreTextBox.Enter += new System.EventHandler(this.scoreTextBox_Enter);
            this.scoreTextBox.Leave += new System.EventHandler(this.scoreTextBox_Leave);
            // 
            // indexTextBox
            // 
            this.indexTextBox.Location = new System.Drawing.Point(118, 280);
            this.indexTextBox.Name = "indexTextBox";
            this.indexTextBox.Size = new System.Drawing.Size(100, 22);
            this.indexTextBox.TabIndex = 19;
            this.indexTextBox.Text = "索引";
            this.indexTextBox.Enter += new System.EventHandler(this.indexTextBox_Enter);
        ...
        private System.Windows.Forms.Button insertButton; // 插入按鈕
        private System.Windows.Forms.TextBox scoreTextBox; // 分數輸入框
        private System.Windows.Forms.TextBox indexTextBox; // 索引輸入框

        private void insertButton_Click(object sender, System.EventArgs e)
        {
            // 嘗試將 scoreTextBox 的文字轉換為整數
            if (int.TryParse(scoreTextBox.Text, out int score) && int.TryParse(indexTextBox.Text, out int position))
            {
                // 確保位置在有效範圍內
                ...
                {
                    // 顯示錯誤訊息，位置超出範圍
                    System.Windows.Forms.MessageBox.Show("索引超出範圍！");
                }
            }
            else
            {
                // 顯示錯誤訊息，輸入無效
                System.Windows.Forms.MessageBox.Show("請輸入有效的分數和索引！");
            }
        }

        private void scoreTextBox_Enter(object sender, System.EventArgs e)
        {
            if (scoreTextBox.Text == "分數")
            {
                scoreTextBox.Text = "";
            }
        }

        private void scoreTextBox_Leave(object sender, System.EventArgs e)
        {
            if (string.IsNullOrWhiteSpace(scoreTextBox.Text))
            {
                scoreTextBox.Text = "分數";
            }
        }

        private void indexTextBox_Enter(object sender, System.EventArgs e)
        {
            if (indexTextBox.Text == "索引")
            {
                indexTextBox.Text = "";
            }
        }

        private void indexTextBox_Leave(object sender, System.EventArgs e)
        {
            if (string.IsNullOrWhiteSpace(indexTextBox.Text))
            {
                indexTextBox.Text = "索引";
            }
        }
    }
}
